...
checkfile = "flowRNNlr0d001_d1_b32_1x128_no5.ckpt"
...
save_checkpoint_path = "/home/lianos91/Desktop/training_patches/model_imgflowRNNd1_1x128/"
#save_checkpoint_path = "/home/lianos91/Desktop/training_patches/rnn_d1_3x256/"

train_err_file = open("train_err_imgflowRNNd1_1x128.txt", "a+")
# Parameters
learning_rate = .0005
...
trainreader = CompositeSequenceReader("train/",istest=False,maxsequence=maxseq)

#trainreader = MySequenceReader("train_tiny/",istest=False,maxsequence=maxseq)
