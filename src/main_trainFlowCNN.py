...
checkfile = "bkgCNNlr0d0001.ckpt"

CNN_checkpoint_path = "/home/lianos91/Desktop/training_patches/model_bkgCNNnamed/"
...
reader = CompositeReader("train/",istest=False)

"""Construct CNN model"""
with tf.variable_scope('bkg'):
    CNNmodel = MyCNN(n_classes,istrainable=True,name='bkg')
